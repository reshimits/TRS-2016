...
<head>
    ...
    ================================================== -->
    <meta charset="utf-8">
    <title>Sitemap // THE RETROFIT SOURCE</title>
...
<body class="utility sitemap">
    ...
    <div class="bodyWrap">
        ...
        <div class="section gray2 short header-waypoint" data-animate-down="header-small" data-animate-up="header-large"> 
            <div class="section">
            <div class="container-fluid"> 
                <div class="col-xs-12 col-md-10 col-md-offset-1 text-center">
                    <h1>Site Map</h1>
                    <h3>If you couldn't find a page before, you can surely find it now!</h3>
                ...
                <div class="col-xs-12 col-sm-6 col-md-5">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item"><p><span class="lead text-gray1"><a href="#">About Us</a></span></p></li>
                        <li class="list-group-item"><p><span class="lead text-gray1"><a href="#">Testimonials</a></span></p></li>
                        <li class="list-group-item"><p><span class="lead text-gray1"><a href="#">Submit a Testimonial</a></span></p></li>
                        <li class="list-group-item"><p><span class="lead text-gray1"><a href="#">Job Opportunities</a></span></p></li>
                    </ul>
                    <h5 class="text-white">Partners</a></h5>
                    <ul class="list-group">
                        <li class="list-group-item"><p><span class="lead text-gray1"><a href="#">Partners</a></span></p></li>
                        <li class="list-group-item"><p><span class="lead text-gray1"><a href="#">Become a Dealer</a></span></p></li>
                        <li class="list-group-item"><p><span class="lead text-gray1"><a href="#">Morimoto HID</a></span></p></li>
                    </ul>
                    <h5 class="text-white">Help Desk</h5>
                    <ul class="list-group">
                        <li class="list-group-item"><p><span class="lead text-gray1"><a href="#">FAQ</a></span></p></li>
                    </ul>
                    <h5 class="text-white">Resources</a></h5>
                    <ul class="list-group">
