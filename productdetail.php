...
<head>
    ...
    ================================================== -->
    <meta charset="utf-8">
    <title>Product Detail // THE RETROFIT SOURCE</title>
...
<body class="productdetail" id="wholesaleAcct">
    ...
    <div class="bodyWrap">
                        ...
                        <div class="row">
                            <div class="carousel slide article-slide" id="trsCarousel">
                                ...
                                <ol class="carousel-indicators col-xs-12 hidden-xs">
                                    ...
                                    <li data-slide-to="3" data-target="#trsCarousel"></li>  
                                    <li data-slide-to="4" data-target="#trsCarousel"></li>
        ...
        <div class="section main gray3 header-waypoint" data-animate-down="header-small" data-animate-up="header-large"> 
            <div class="container-fluid">   
                ...
                <div class="col-xs-10 col-xs-offset-1 text-center icon-features">
                    ...
                    <div type="button" data-container="body" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." class="btn btn-empty btn-hexicon"><span class="icon icon-mapHex"></span></div>
                    <div type="button" data-container="body" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." class="btn btn-empty btn-hexicon"><span class="icon icon-messageHex"></span></div>
                    <div type="button" data-container="body" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." class="btn btn-empty btn-hexicon"><span class="icon icon-phoneHex"></span></div>
                    <div type="button" data-container="body" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." class="btn btn-empty btn-hexicon"><span class="icon icon-phoneHex"></span></div>
                    <div type="button" data-container="body" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." class="btn btn-empty btn-hexicon"><span class="icon icon-phoneHex"></span></div>
                </div> -->
        ...
        <div class="section title">
            <div class="container-fluid">
                <div class="col-xs-12">
                    <h2 class="text-center">In Action</h2>
                </div>
            </div>    
        </div>
        ...
        <div class="section title">
            <div class="container-fluid">
                <div class="col-xs-12">
                    <h2 class="text-center">Also Purchased</h2>
                </div>
            </div>    
        </div>
                ...
                <ul class="row productGrid">
                    ...
                    <li class="col-xs-12 col-sm-6 col-md-4 product thumbnail">
                        <a href="productdetail.php" class="thumb-top">
                            ...
                            <div class="thumbnail-image"><img src="img/category-led-colorchanging.png" class="img-responsive" alt="" border="none"></div>
                        </a>
                        <div class="labelWrap">
