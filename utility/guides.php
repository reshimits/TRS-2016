...
<head>
    ...
    ================================================== -->
    <meta charset="utf-8">
    <title>Install Guides // THE RETROFIT SOURCE</title>
...
<body class="utility resources guides">
    ...
    <div class="bodyWrap">
        ...
        <div class="jumbotron">
            <div class="featureHeadline col-xs-12">
                <div class="col-xs-12 col-sm-8">
                    ...
                    <h5 class="text-white">All the info you'll need, including cool tips / tricks to install your componenets.</h5>
                </div>
        ...
        <div class="section gray3 header-waypoint" id="guides" data-animate-down="header-small" data-animate-up="header-large"> 
