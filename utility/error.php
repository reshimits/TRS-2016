...
<head>
    ...
    ================================================== -->
    <meta charset="utf-8">
    <title>Error! // THE RETROFIT SOURCE</title>
        ...
        <div class="section details short header-waypoint" data-animate-down="header-small" data-animate-up="header-large"> 
            ...
            <div class="container-fluid"> 
                <div class="col-xs-12 col-md-10 col-md-offset-1 text-center">
                    <h1>Error!</h1>
                    <h3>Our website made a mistake, sorry about that...</h3>
                    <hr class="aligncenter">
                    <h5 class="text-gray1">We sincerely apologize for the inconvenience, but your last action could not be completed for some reason.</h5>
