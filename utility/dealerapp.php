...
<head>
    ...
    ================================================== -->
    <meta charset="utf-8">
    <title>Dealer Application // THE RETROFIT SOURCE</title>
...
<body class="utility partners dealerapp">
        ...
        <div class="jumbotron">
            <div class="featureHeadline col-xs-12">
                <div class="col-xs-12 col-sm-8">
                    <h1>Dealer App<span class="hidden-sm">lication</span></h1>
                    <h5 class="text-white">Wholesale is a big part of what we do. Partner with the best brands in automotive lighting.</h5>
                </div>
       ...
       <div class="section wrap header-waypoint" data-animate-down="header-small" data-animate-up="header-large">
                ...
                <div class="col-xs-12 col-sm-5 col-lg-6 section">
                    ...
                    <div class="col-xs-12 details">
                        <h3>Why Apply?</h3>
                        <p><span class="text-weightBold">If your shop or retail outlet deals with automotive lighting upgrades, there’s no doubt you’ve heard of The Retrofit Source. </span></p>
                        <p>In business since 2005, we are honored to have become be one of the biggest, most well respected outlets for aftermarket lighting products in the world. The size of our footprint grows each year thanks to our partnerships with over 350 authorized dealers worldwide. The Retrofit Source welcomes dealer inquiries from all and approves only the most qualified. </p>
                        ...
                        <form class="form-horizontal">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="inputDefault" placeholder="Company Tax ID / EIN Number">
                                    </div>
                                </div>
