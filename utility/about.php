...
<head>
    ...
    ================================================== -->
    <meta charset="utf-8">
    <title>About Us // THE RETROFIT SOURCE</title>
...
<body class="utility about">
    ...
    <div class="bodyWrap">
        ...
        <div class="section wrap briefhistory header-waypoint" data-animate-down="header-small" data-animate-up="header-large">
            ...
            <div class="flex-row">
                <div class="col-xs-12 col-sm-6 section bg-primary blockquote2 hidden-xs">
                    <div class="container-fluid">
                    <div class="col-xs-12">
                        <div class="section">
                        <div class="blockquote">
                ...
                <div class="col-xs-12 col-sm-6 section">
                    ...
                    <div class="col-xs-12">
                        ...
                        <p>Whether you're just getting started by dealing with our excellent customer service or you're already comfortably cruising on that dark road at night, you'll be glad you dealt with The Retrofit Source.Huge thanks to all who give us the pleasure of serving you!</p>

                        <p>Yours truly,</p>
                        <div class="section wrap">
                            <div class="col-xs-6 col-md-4">
                            <div class="row">
                                <img src="../img/mattSignature2x.jpg" class="img-responsive" alt="" border="Matt Kossoff Signature">
                            </div>
                            </div>
                        </div>
        ...
        <div class="section title">
            <div class="container-fluid">
                <div class="col-xs-12">
                    <h2 class="text-center">The TRS Crew</h2>
                </div>
            </div>    
        </div>

        <div class="jumbotron content crew">
            <div class="jumbotron-img"></div>
        </div>
             ...
             <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12 col-sm-3 thumbnail-image" data-toggle="modal" data-target="#photoLightbox">
                        ...
                        <div class="row">
                            <img src="../img/ourshop1.jpg" class="img-responsive" alt="" border="none">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-3 thumbnail-image" data-toggle="modal" data-target="#photoLightbox">
                        <span class="icon icon-magnify"></span>
                        <div class="row">
                            <img src="../img/ourshop2.jpg" class="img-responsive" alt="" border="none">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-3 thumbnail-image" data-toggle="modal" data-target="#photoLightbox">
                        <span class="icon icon-magnify"></span>
                        <div class="row">
                            <img src="../img/ourshop3.jpg" class="img-responsive" alt="" border="none">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-3 thumbnail-image" data-toggle="modal" data-target="#photoLightbox">
                        <span class="icon icon-magnify"></span>
